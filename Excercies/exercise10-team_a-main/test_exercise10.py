...
import exercise10 as studentScript

# import reference results
refResults: dict = np.load("exercise10_refSol.npz")
...
def test_3():
    """ check if the function is implemented correct (1 point) """
    checkVariableSimilar("x_predict_test")
    checkVariableSimilar("P_predict_test")
    checkVariableSimilar("F_test")
    checkVariableSimilar("F_jacobian_test")
...
def test_4():
    """ check if C and covariance matrices are correct (1 points) """
    checkVariableSimilar('C1')
    checkVariableSimilar('C2')
    checkVariableSimilar('C3')
    checkVariableSimilar('V1')
    checkVariableSimilar('V2')
    checkVariableSimilar('V3')
